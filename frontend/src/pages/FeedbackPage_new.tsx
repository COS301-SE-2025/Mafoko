        ...
        <main className="feedback-main">
          <div className="feedback-container">
            <div className="feedback-header">
              <h1 className="feedback-title">We Value Your Voice</h1>
              <p className="feedback-subtitle">
                Help us improve by sharing your suggestions, complaints, or
                compliments. Every piece of feedback matters to us.
              </p>
            </div>
            ...
            <div className="feedback-card">
              ...
              <div className="feedback-form-container">
                <div className="form-header">
                  <h2 className={`form-title ${activeTabData.color}`}>
            ...
            <div className="feedback-footer">
              <p>
                Your feedback helps us serve you better. Thank you for taking
                the time to share!
              </p>
            </div>
          </div>
