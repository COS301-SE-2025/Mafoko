...
export const GlossaryContent: SectionProps[] = [
  {
    ...
    content: (
      <p>
        Use the <strong>search bar</strong> to quickly find a glossary by name.
        As you type, matching glossaries will be returned for you to open.
      </p>
    ),
    assetLocation: '',
  },
  ...
  },
  {
    ...
    content: (
      <p>
        Click the <strong>View Translations</strong> button on a term to see all
        available translations for that entry.
      </p>
    ),
    assetLocation: '',
  },
