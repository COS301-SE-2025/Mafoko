            ...
            <div className="article-section-inner">
              ...
              <div className="article-content article-scrollable-content">
                <div className="p-6 max-w-4xl mx-auto space-y-12 text-base leading-relaxed text-left">
                  {/* INTRO */}
                  <section id="intro">
                    <h1 className="text-3xl font-bold text-theme mb-4">Understanding Terms in Marito</h1>
                    <p>
                      In Marito, terms are the heart of the glossary. Each entry reflects a concept in one of South Africa's 11 official languages,
                      helping communities preserve linguistic richness while supporting accurate translations and search functionality.
                    </p>
                  </section>

                  {/* WHAT IS A TERM */}
                  <section id="what-is-a-term">
                    <h2 className="text-2xl font-semibold text-theme mb-3">What is a Term?</h2>
                    <p>Every term Marito contains the following fields:</p>
                    <ul className="list-disc list-inside ml-4 space-y-1">
                      <li><strong>Term:</strong> The actual word or phrase (e.g., Ubuntu)</li>
                      <li><strong>Language:</strong> One of South Africa’s 11 official languages the term belongs to</li>
                      <li><strong>Domain:</strong> The context or subject area (e.g. Law, Technology, Education)</li>
                      <li><strong>Definition:</strong> A clear, concise description or meaning of the term</li>
                      <li><strong>Upvotes / Downvotes:</strong> Community-driven scoring to indicate accuracy or usefulness</li>
                    </ul>
                  </section>

                  {/* LANGUAGES */}
                  <section id="languages">
                    <h2 className="text-2xl font-semibold text-theme mb-3">Supported Languages</h2>
                    <p>Marito supports all 11 official South African languages and you can filter and explore terms in any of these languages using the search filters.</p>
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-sm">
                      {[
                        "Afrikaans", "English", "isiNdebele", "isiXhosa", "isiZulu", "Sesotho",
                        "Sepedi", "Setswana", "Siswati", "Tshivenda", "Xitsonga"
                      ].map(lang => (
                        <div key={lang} className="px-3 py-1 rounded bg-gray-100 dark:bg-gray-700">{lang}</div>
                      ))}
                    </div>
                  </section>
                  ...
                  <section id="how-search-works">
                    <h2 className="text-2xl font-semibold text-theme mb-3">How Searching Works</h2>
                    <p>
                      The search functionality in Marito is designed to help you explore glossary terms quickly and efficiently across all 11 official South African languages. Whether you're looking for a specific translation, trying to understand a domain-specific term, or exploring linguistic relationships, the search engine adapts to your needs.
                    </p>

                    <p>
                      You’ll find the search bar prominently at the top of the page. As you type, Marito performs a live search, updating results in real-time based on your input. This makes it easy to experiment with different keywords, spelling variants, or even partial matches.
                    </p>

                    <ul className="list-disc list-inside ml-4 space-y-2">
                      <li><strong>Term:</strong> The primary label or phrase representing a concept.</li>
                    ...
                    <p>
                      You can combine search with filters and sorting to refine your experience (see the sections below). For offline use, remember to download the relevant dictionaries from the dictionary page.
                    </p>

                    <p><em>A video tutorial is available below that demonstrates the full search workflow.</em></p>
                  ...
                  <section id="search-and-filters">
                    <h2 className="text-2xl font-semibold text-theme mb-3">Search & Filter Options</h2>
                  ...
                  <section id="offline-use">
                    <h2 className="text-2xl font-semibold text-theme mb-3">Offline Usage</h2>
                    <p>
