          ...
          <section className="article-section">
            <div className="article-section-inner">
              ...
              <div className="article-content article-scrollable-content">
                ...
                <section id="intro">
                  <h1 className="text-3xl font-bold text-theme mb-4">Getting Started with Marito</h1>
                  <div className="space-y-6 leading-relaxed text-base">
                    <p>
                      Welcome to Marito, your gateway to exploring and
                      contributing to South Africa’s multilingual digital lexicon.
                      Whether you're a linguist, contributor, or NLP researcher,
                      this guide will help you get up and running with everything
                      Marito offers.
                    </p>
                  </div>
                ...
                <section id="workflow">
                  ...
                  <div className="text-left space-y-6 leading-relaxed text-base">
                    ...
                    <ol className="list-decimal list-inside space-y-4">
                      <li>
                        <strong>Create an Account:</strong> Register to contribute
                        terms, bookmark favourites, and access Marito’s full set
                        of features tailored to your usage.
                      </li>

                      <li>
                        <strong>Search and Explore:</strong> Use the{' '}
                        <em>search bar</em> to look up terms in any of South
                        Africa’s official languages. Refine results using filters
                        like language and domain. Enable AI Search and Fuzzy
                        Search to enhance your search accuracy.
                      </li>
                      ...
                      <li>
                        <strong>Offline Usage:</strong> As a PWA, Marito caches
                        your searches, saved terms, and pages for seamless use
                        without an internet connection.
                      </li>

                      <li>
                        <strong>Get Feedback & Iterate:</strong> Share terms,
                        insights, or downloads with peers. Use your findings to
                        enhance NLP tools, inform glossaries, or preserve
                        linguistic heritage.
                      </li>
                    </ol>
                    <p>
