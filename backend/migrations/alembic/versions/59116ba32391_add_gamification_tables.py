...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_achievements_achievement_type"),
        "achievements",
        ["achievement_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_userachievements_achievement_id"),
        "userachievements",
        ["achievement_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_userachievements_earned_at"),
        "userachievements",
        ["earned_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_userachievements_id"), "userachievements", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_userachievements_user_id"),
        "userachievements",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_userlevels_user_id"), "userlevels", ["user_id"], unique=True
    )
    op.create_table(
        "userxps",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_userxps_created_at"), "userxps", ["created_at"], unique=False
    )
    op.create_index(op.f("ix_userxps_id"), "userxps", ["id"], unique=False)
    op.create_index(
        op.f("ix_userxps_source_reference_id"),
        "userxps",
        ["source_reference_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_userxps_xp_source"), "userxps", ["xp_source"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_userachievements_achievement_id"), table_name="userachievements"
    )
