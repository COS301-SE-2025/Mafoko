...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_bookmarked_terms_id"), "bookmarked_terms", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_bookmarked_terms_user_id"),
        "bookmarked_terms",
        ["user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_bookmarked_terms_term_id"),
        "bookmarked_terms",
        ["term_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_bookmarked_glossaries_id"),
        "bookmarked_glossaries",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_bookmarked_glossaries_user_id"),
        "bookmarked_glossaries",
        ["user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_bookmarked_glossaries_domain"),
        "bookmarked_glossaries",
        ["domain"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "group_type",
            sa.Enum("TERMS", "GLOSSARIES", "MIXED", name="grouptype"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_workspace_groups_id"), "workspace_groups", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_workspace_groups_name"), "workspace_groups", ["name"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "item_type", sa.Enum("TERM", "GLOSSARY", name="itemtype"), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["group_id"], ["workspace_groups.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["term_id"], ["terms.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_workspace_group_items_id"),
        "workspace_group_items",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workspace_group_items_group_id"),
        "workspace_group_items",
        ["group_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workspace_group_items_term_id"),
        "workspace_group_items",
        ["term_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workspace_group_items_domain"),
        "workspace_group_items",
        ["domain"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_workspace_group_items_domain"), table_name="workspace_group_items"
    )
    op.drop_index(
        op.f("ix_workspace_group_items_term_id"), table_name="workspace_group_items"
    )
    op.drop_index(
        op.f("ix_workspace_group_items_group_id"), table_name="workspace_group_items"
    )
    op.drop_index(
        op.f("ix_workspace_group_items_id"), table_name="workspace_group_items"
    )
    ...
    op.drop_index(
        op.f("ix_bookmarked_glossaries_domain"), table_name="bookmarked_glossaries"
    )
    op.drop_index(
        op.f("ix_bookmarked_glossaries_user_id"), table_name="bookmarked_glossaries"
    )
    op.drop_index(
        op.f("ix_bookmarked_glossaries_id"), table_name="bookmarked_glossaries"
    )
