...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('suggestion', 'complaint', 'compliment', name='feedback_type_enum'), nullable=False),
    sa.Column('message', sa.Text(), nullable=False),
    sa.Column('name', sa.String(length=100), nullable=True),
    sa.Column('email', sa.String(length=100), nullable=True),
    sa.Column('user_id', sa.UUID(), nullable=True),
    sa.Column('status', sa.Enum('open', 'in_progress', 'resolved', 'closed', name='feedback_status_enum'), nullable=False),
    ...
    op.create_index(op.f('ix_feedbacks_resolved_by_user_id'), 'feedbacks', ['resolved_by_user_id'], unique=False)
