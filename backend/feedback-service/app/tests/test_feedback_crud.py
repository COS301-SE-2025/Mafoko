...
class TestCRUDFeedback:
    ...
    async def test_create_feedback_anonymous(self, db_session: AsyncSession, sample_feedback_data):
    ...
    async def test_create_feedback_with_user(self, db_session: AsyncSession, sample_feedback_data, regular_user_data):
    ...
    async def test_get_feedback_by_id(self, db_session: AsyncSession, sample_feedback_data):
        """Test retrieving feedback by ID."""
        feedback_create = FeedbackCreate(**sample_feedback_data)
        created_feedback = await crud_feedback.create(db_session, obj_in=feedback_create)
    ...
    async def test_get_multi_feedback(self, db_session: AsyncSession):
        ...
        feedback_data = [
            {"type": FeedbackType.complaint, "message": "Issue 1", "name": "User 1", "email": "user1@test.com"},
            {"type": FeedbackType.suggestion, "message": "Suggestion 1", "name": "User 2", "email": "user2@test.com"},
            {"type": FeedbackType.compliment, "message": "Great job!", "name": "User 3", "email": "user3@test.com"},
        ]
    ...
    async def test_update_feedback(self, db_session: AsyncSession, sample_feedback_data, admin_user_data):
        ...
        assert updated_feedback.admin_response == "Thank you for your feedback. We have addressed the issue."
        assert updated_feedback.resolved_at is not None
        assert updated_feedback.resolved_by_user_id == admin_user.id

    async def test_delete_feedback(self, db_session: AsyncSession, sample_feedback_data):
    ...
    async def test_get_stats(self, db_session: AsyncSession):
        ...
        feedback_data = [
            {"type": FeedbackType.complaint, "message": "Issue 1", "name": "User 1", "email": "user1@test.com"},
            {"type": FeedbackType.complaint, "message": "Issue 2", "name": "User 2", "email": "user2@test.com"},
            {"type": FeedbackType.suggestion, "message": "Suggestion 1", "name": "User 3", "email": "user3@test.com"},
            {"type": FeedbackType.compliment, "message": "Great job!", "name": "User 4", "email": "user4@test.com"},
        ]
        ...
        await crud_feedback.update(db_session, db_obj=resolved_feedback, obj_in=update_data)
    ...
    async def test_search_feedback(self, db_session: AsyncSession):
        ...
        feedback_data = [
            {"type": FeedbackType.complaint, "message": "The search feature is broken", "name": "User 1", "email": "user1@test.com"},
            {"type": FeedbackType.suggestion, "message": "Please improve the UI design", "name": "User 2", "email": "user2@test.com"},
            {"type": FeedbackType.complaint, "message": "Login system has security issues", "name": "User 3", "email": "user3@test.com"},
        ]
