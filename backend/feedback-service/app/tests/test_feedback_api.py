...
class TestFeedbackAPI:
    ...
    async def test_submit_feedback_authenticated(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_regular_user
    ):
    ...
    async def test_get_my_feedback_success(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_regular_user
    ):
    ...
    async def test_get_specific_feedback_as_owner(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_regular_user
    ):
        ...
        feedback_create = FeedbackCreate(
            type=FeedbackType.suggestion, message="Specific feedback", name="Test User"
        )
    ...
    async def test_get_specific_feedback_forbidden(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_regular_user
    ):
        ...
        feedback = await crud_feedback.create(
            db_session, obj_in=feedback_create, user_id=other_user_id
        )
        ...
        try:
            ...
            )  # Forbidden - can't access other user's feedback
        finally:
            # Clean up override
            del app.dependency_overrides[deps.get_current_active_user]

    async def test_get_all_feedback_admin_success(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_admin_user
    ):
        ...
        feedback_create = FeedbackCreate(
            type=FeedbackType.suggestion, message="Admin can see this", name="Test User"
        )
        ...
        app.dependency_overrides[deps.get_current_active_admin] = (
            override_get_current_active_admin
        )
    ...
    async def test_get_all_feedback_non_admin_forbidden(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_regular_user
    ):
    ...
    async def test_update_feedback_admin_success(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_admin_user
    ):
        ...
        # Create feedback
        feedback_create = FeedbackCreate(
            type=FeedbackType.complaint, message="Needs admin attention", name="User"
        )
        feedback = await crud_feedback.create(
            db_session, obj_in=feedback_create, user_id=None
        )
        ...
        try:
            ...
            response = await client.put(
                f"/api/v1/feedback/{feedback.id}", json=update_data
            )
    ...
    async def test_delete_feedback_admin_success(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_admin_user
    ):
        ...
        # Create feedback
        feedback_create = FeedbackCreate(
            type=FeedbackType.suggestion, message="To be deleted", name="User"
        )
        feedback = await crud_feedback.create(
            db_session, obj_in=feedback_create, user_id=None
        )
    ...
    async def test_get_feedback_stats_admin(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_admin_user
    ):
    ...
    async def test_search_feedback_admin(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_admin_user
    ):
    ...
    async def test_search_feedback_short_query(
        self, client: httpx.AsyncClient, db_session: AsyncSession, mock_admin_user
    ):
