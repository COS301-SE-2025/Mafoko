...
\begin{enumerate}[label=FR\arabic*:, leftmargin=2.5em]
    ...
    \item \textbf{Dictionary, Glossary and Term Bank Management}
    FR1.1: Multi-source Content Access
    \begin{itemize}
        \item FR1.1.1: The system shall allow users to search for word meanings in a dictionary.
        \item FR1.1.2: The system shall allow users to browse glossaries by domain/category.
        \item FR1.1.3: The system shall provide access to specialized terminology databases with multilingual term definitions for specific fields (legal, medical, technical).
    \end{itemize}
    FR1.2: Browsing and Search
    \begin{itemize}
        \item FR1.2.1: The system shall allow users to browse available glossaries and term banks.
        \item FR1.2.2: The system shall provide a unified search interface across all multilingual glossaries.
        \item FR1.2.3: The system shall allow users to search for terms using exact matches, partial strings, or semantic similarity.
        \item FR1.2.4: The search results shall be ranked by relevance and display key metadata (definition, part of speech, language).
        \item FR1.2.5: The system shall highlight related terms and translations in the term view.
    \end{itemize}
